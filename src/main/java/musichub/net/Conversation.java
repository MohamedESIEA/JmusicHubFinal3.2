...
/**
 * La classe Conversation, c'est la classe qui va gerer la communication entre le serveur est chaque client
...
public class Conversation extends Thread implements Observer{
     ...
     * @param numClient Le numero du client associe a cet socket
     */
     ...
     * @param msg le message à envoyer vers le client
     * @return Retourne la taille du message s'il est bien envoyé, -1 s'il ya un probleme.
     */
    ...
    /**
     * Recuperer le dernier message reçu par la conversation
     * @return Le message reçu par la Conversation, si non renvoie null
     */
...
* */
     ...
     * Exp: si un client a ajouté une nouvelle chanson, Tous les autres clients seront notifié
     ...
     * @param choice C'est la commande envoyer par le client (q, a , j...)
     */
    ...
    /**
     * Une methode appelle une seule fois dans le constructeur pour preparer le menu.
