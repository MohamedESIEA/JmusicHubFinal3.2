...
/**
 * La classe Client, c'est une classe qui implèmente l'interface IClient
 * @author Mohamed, Aymane, Mazen, Niama
 */
public class Client implements IClient{
    ...
    /**
     * Le conctructeur de la classe Client
     * @param port C'est le port qui permet au serveur d'ecouter
     * @param username Le nom du client, mais on ne l'utilise pas
     */
    ...
    /**
     * Etablie une connection TCP avec le serveur dont l'adresse est passer en parametre.
     * Creer deux Thread, sendThread pour se charger de l'envoie de ce que le client tape
     * et receiveThread permet de recevoir ce que le serveur nous envoie
     ...
     * @return le nom du client connecté
     */
     ...
     * @return Retourne la taille du message s'il est bien envoyé, -1 s'il ya un probleme (Exp: Client deconnecté)
     */
    @Override
